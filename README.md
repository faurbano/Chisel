...
<p align='justify'> La compuerta XOR, también conocida como OR Exclusiva, se representa como en la Figura 1. Las entradas `X` y `X`, y la salida `result`, son de un bit. 
